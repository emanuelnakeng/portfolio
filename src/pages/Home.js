	...
	return (
		<ScreenWrap>
			<section className='container mx-auto px-5 flex flex-col gap-8 py-16'>
				...
				<h1 className='font-bold text-8xl text-dark-clr sm:w-11/12'>
			...
			<section className='container mx-auto px-5 flex flex-col gap-5 pt-16 pb-10'>
				<h2 className='font-bold text-6xl text-dark-clr'>
					Discover my popular work
				</h2>
				<p>Work goes here</p>
			</section>
			<section className='container mx-auto px-5 flex flex-col gap-8 py-16'>
				<h2 className='font-bold text-6xl text-dark-clr sm:w-5/6'>
					Creating intuitive and engaging user experiences
				</h2>
				<h3 className='font-base text-lg text-dark-clr sm:w-5/6'>
			...
			<section className='container mx-auto px-5 flex flex-col gap-8 border-t-[0.1px] border-t-border-clr/40  justify-center items-center gap-8 py-16'>
				...
				<h2 className='font-bold text-8xl text-dark-clr text-center'>
